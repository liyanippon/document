...
<%try{	
	...
	<%	} 
		...
		{
			IsSucceed = Employee.Add(employeeid,username,sex,branch,nativeplace,marriage,identityid,politics,folk,education,department,university,
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  %>
	...
	<form name="form2" method="post" action="AddEmployeeStep1.jsp">
