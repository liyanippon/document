...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#F4E193">
  <tr>
    <td width="780" height="13" class="td3"><div align="center"><a href="index.jsp">首页</a></div></td>
    <td width="780"><div align="center"><a href="../consumer/ViewEmployeeStep1.jsp?employeeid=<%=employeeid%>">查看个人信息</a></div></td>
    <td width="780"><div align="center"><a href="../consumer/ViewPay.jsp?employeeidd=<%=employeeid%>">查看工资信息</a></div></td>
    <td width="780"><div align="center"><a href="../Logout.jsp">退出系统</a></div></td>
