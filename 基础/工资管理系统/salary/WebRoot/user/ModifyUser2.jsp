...
try{	
	...
	String newuser = new String(request.getParameter("newuser").getBytes("ISO8859_1"),"GBK");
	String password1 = new String(request.getParameter("password1").getBytes("ISO8859_1"),"GBK");
	String newpower = new String(request.getParameter("newpower").getBytes("ISO8859_1"),"GBK");
	IsSucceed = User.Modify(newuser,password1,newpower,userid);		
	}
	catch(Exception e){
