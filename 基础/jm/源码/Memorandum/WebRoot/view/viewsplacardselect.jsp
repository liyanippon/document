...
<head>
	...
	<title>viewsplacardselect.jsp</title>
...
<body>
	...
	<logic:notEmpty name="list_GamesBeanSelect">
		<logic:iterate id="list_Game"
			collection="${requestScope.list_GamesBeanSelect}">
			<TABLE width=642 height="428" cellSpacing="0" cellPadding="0"
				border="0" class="inputframemain">
				<IMG src="../view/images/zheng.jpg">
				...
				<TR>
					<TD align="center" height="3%">
						<font color="#dc143c" size="5"><br> ${list_Game.zhuti}</font>
					</TD>
				...
				<TR>
					<TD height="5%" colSpan=2 align="right">
						作者:${list_Game.zuozhe}&nbsp;&nbsp;发表时间:
						<bean:write name="list_Game" property="shijian"
