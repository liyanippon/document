...
public class EnrollDAO {
	...
	public long count(String name, String pid, String specialty_id,
			String school_id, String class_id, String state_id) throws Exception {
		StringBuffer sql = new StringBuffer();
		sql.append("SELECT ");
		...
		ResultSet set = pst.executeQuery();
		set.next();
		long ct=set.getLong("ct");
		con.close();
		return ct;
	}
	
	public void delete(String[] eid) throws Exception{
		String sql="DELETE FROM enroll WHERE id IN(";
