  ...
  <div class="right_div spe_div">
    ...
    <table width="700" border="0" cellpadding="0" cellspacing="0" class="spe_table">
      <tr>
        ...
        <td width="289" align="center" class="cell_title">用&nbsp;&nbsp;户&nbsp;&nbsp;名</td>
      ...
      <tr style="background-color:#fcfcfc">
      	<td height="32" align="center" class="cell">
        	<input name="userId" id="" type="checkbox" value="" />
        </td>
        <td align="center" class="cell_num">1</td>
        <td align="center" class="cell" name="username">A</td>
      ...
      <tr style="background-color: #E3FAE3">
        ...
        <td align="center" class="cell" name="username">B</td>
        <td align="center" class="cell"><img src="../../pic/delete.png" width="22" onclick=""/></td>
      </tr>
      <!-- 
    ...
    <input type="hidden" name="username" id="st1" value=""/>
    <input type="hidden" name="password" id="st2" value=""/>
    </form>
    <div class="spe_div">
