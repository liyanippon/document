  ...
  <div class="right_div spe_div">
    ...
    <table width="700" border="0" cellpadding="0" cellspacing="0" class="spe_table">
      <tr>
        ...
        <td width="289" align="center" class="cell_title">年&nbsp;&nbsp;届</td>
        <td width="157" align="center" class="cell_title">操&nbsp;&nbsp;作</td>
      </tr>
      
      <tr style="background-color:#fcfcfc">
      	<td height="32" align="center" class="cell">
        	<input name="yearId" id="" type="checkbox" value="" />
        </td>
        <td align="center" class="cell_num">1</td>
        <td align="center" class="cell" name="yearName">2012</td>
        <td align="center" class="cell">
        <img src="../../pic/delete.png" width="22" onclick=""/></td>
      </tr>
        ...
        <td align="center" class="cell" name="yearName">2013</td>
        <td align="center" class="cell">
        <img src="../../pic/delete.png" width="22" onclick=""/></td>
      </tr>
      <!-- 
    ...
    <input type="hidden" name="year" id="st" value=""/>
    </form>
    <div class="spe_div">
