...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="border:1px; border-style:solid; border-color:#888888">
  <tr>
    <td width="20"></td>
		...
		<img src="images/eportal.gif" align="left" alt="websitelogo"><IMG src="images/icon_login.gif" align="bottom" > 
		<INPUT id="qKey" name="qKey" value="搜索让购物变得简单" style="font-family: italic; color: Gray" onClick="this.value='' "> 
        <select id="category">
		...
		<A href="javascript:QuickSearch()"><IMG src="images/icon_search.gif" align="bottom" border="0" style="height: 19px"></A>    	
	</TD>
    <td width="20">&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td style="height: 1105px"><table width="100%" border="0" cellpadding="0" cellspacing="0"> 
 
   
      <tr>

        <td width="200" valign="top" style="height: 1141px"><TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
             <tr>&nbsp;</tr> 
            <TR>
	                    ...
	                    <TR>
	                      <TD>
							  <TABLE cellSpacing=0 cellPadding=0 width="90%" align=center border=0>
		                           ...
		                           <TR height="30">
		                             <TD class="UserRegster" align="center">
                ...
                <TD class="C_Item_bg" valign="top">
					<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
					  ...
					  <logic:present name="cateList">
						  ...
						  <TR>
							<TD class="text">
								&nbsp;<img border="0" src="images/cateIcon.gif">
