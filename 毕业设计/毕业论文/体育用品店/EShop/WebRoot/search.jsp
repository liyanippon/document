...
页<input type="button"  style="color:white; border:0;background-color:3366cc;weight:40px;height:20px" id="go" value="跳转" name="go" onClick="goPage()">   				第<span class="redText"><%=pageNo%></span>页/共<span class="redText"><%=totalPages%></span>页　
