...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="border:1px; border-style:solid; border-color:#888888">
  <tr>
    ...
    <TD height="50" align="right" valign="bottom">
		<IMG src="images/icon_login.gif" align="middle"> 
		<INPUT id="qKey" name="qKey" value="搜索让购物变得简单" onClick="this.value=''"> 
		<SELECT id="category" name="category">
			<option value="0">所有商品</option>
		</SELECT>
		<A href="javascript:QuickSearch()"><IMG src="images/icon_search.gif" align="middle" border="0"></A>    </TD>
    <td width="20">&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
        ...
        <td align="center"><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
			...
			<logic:present name="wordList">
			  <logic:iterate id="word" name="wordList" type="com.ORM.Leaveword">
				...
				<table width="90%" border="0" cellpadding="4" cellspacing="0" style="border:1px; border-color:black; border-style:solid;">
				  ...
				  <tr>
					<td class="text" colspan="2" style="color:black">${word.content}</td>
				  </tr>
				  ...
				  <tr>
					<td class="text" colspan="2" style="color:#40AA53">${word.answerContent}</td>
				  </tr>
				  </logic:present>
				</table>
          ...
          <tr bgcolor="#F7F3F7">
            <td height="26" bgcolor="#FFFFFF" align="center" class="text">
				...
				往第<input type="text" id="willGoPage" name="willGoPage" class="control" size="2" onKeyPress="return isNumber()">
				页<input type="button"  style="color:white; border:0;background-color:3366cc;weight:50px;height:20px" id="go" value="跳 转" name="go" onClick="goPage()">   　
          ...
          <tr bgcolor="#F7F3F7">
			...
			<form name="form1" action="mem.do?method=addWord" method="post" style="margin:0px;">
			   <table width="94%" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td height="35"><input type="button" class="C_Input"  onClick="checkForm()" value="提交留言"/>
...
<script language="javascript">
	...
	function QuickSearch(){
		...
		if (key !=null && key!="搜索让购物变得简单" && key.length>0)url = url+"&key="+key;
		window.location = url;
	}
