...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="border:1px; border-style:solid; border-color:#888888">
  <tr>
    ...
    <TD height="50" align="right" valign="bottom">
		...
		<A href="javascript:QuickSearch()"><IMG src="images/icon_search.gif" align="middle" border="0"></A>    	
	</TD>
    <td width="20">&nbsp;</td>
  </tr>
  <tr>
...
页<input type="button"  style="color:white; border:0;background-color:3366cc;weight:40px;height:20px" id="go" value="跳转" name="go" onClick="goPage()">   
