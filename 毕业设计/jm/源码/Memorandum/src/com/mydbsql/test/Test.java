...
public class Test {
	...
	/**
	 * 1. select * from table 2. select * from table where 3. select * from
	 * tableA , tableB 4. select * from tableA where * from (select * from
	 * tableB) 5. select * from tableA where * from (select * from tableB where *
	 * from (select * from tableC))... 6. select * from tableA union select *
	 * from tableB 7. select * from tableA (left/right) join tableB on ...
	 * 
