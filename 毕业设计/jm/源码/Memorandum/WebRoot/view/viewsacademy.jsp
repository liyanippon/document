...
<body>
	...
	<TABLE border=1 cellSpacing=1 borderColor=#ffffff cellPadding=1
		...
		<TBODY>
			...
			<IMG src="../view/images/yuanxi.jpg">
				...
				<logic:notEmpty name="list_cb">
					<logic:iterate id="cbsql" collection="${requestScope.list_cb}">
						<tr>
							<td width=500>
								<a
									href="../vindex.do?method=academyselect&cid=${cbsql.cid}">${cbsql.zhuti}</a>
							</td>
							<td width=142>
								<FONT color="#336699"><bean:write name="cbsql"
										property="shijian" format="yyyy-MM-dd hh:mm:ss" />
								</FONT>
							</td>
						</tr>
			...
			<TABLE border=1 cellSpacing=1 borderColor=#ffffff cellPadding=1
				...
				<logic:iterate id="ff" collection="${requestScope.list_f}">
					<tr>
						<td align="right">
							<font color="#ffffff">每页15条&nbsp;</font><a href='../vindex.do?method=academy&sum=0&shang=${ff.shang}'>上一页</a>
							|
							<a href='../vindex.do?method=academy&sum=0&xia=${ff.xia}'>下一页</a>
						</td>
					</tr>
				</logic:iterate>
			</TABLE>
